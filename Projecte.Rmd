...
```{r Figure 1, echo= FALSE, fig.align = 'center', out.width = "50%", out.extra='trim={0 0.4cm 0 0.4cm},clip', fig.cap = "Figure 1. Quality check reads scores"}
...
```{r Figure 2, echo= FALSE, fig.align = 'center', out.width = "60%", fig.cap = "Figure 2. Bins generated after metagenome assembly"}
...
```{r Figure 3 and 4, echo= FALSE, fig.align = 'center', out.width = "80%", out.extra='trim={0 2.5cm 0 2.5cm},clip', fig.cap = "Figure 3 and 4. Bins completeness and contamination; GC content in bin 3"}
library(png)
library(grid)
library(gridExtra)
...
```{r Figure 5, echo= FALSE, fig.align = 'center', out.width = "90%", out.extra='trim={0 0.5cm 0 0.5cm},clip', fig.cap = "Figure 5. Bacterial Taxonomy classification"}
knitr::include_graphics(here::here("especie_que_correspon_pr5.png"))
```

```{r Figure 6, echo= FALSE, fig.align = 'center', out.width = "60%", out.extra='trim={0 0.5cm 0 0.5cm},clip', fig.cap = "Figure 6. Phylogenetic tree"}
...
```{r Figure 7, echo= FALSE, fig.align = 'center', out.width = "75%", out.extra='trim={0 0.2cm 0 0.2cm},clip', fig.cap = "Figure 7. ANI distance estimation"}
knitr::include_graphics(here::here("ANI_estimate_ambos_pr5.png"))
```

```{r Figure 8, echo= FALSE, fig.align = 'center', out.width = "35%", out.extra='trim={0 0.2cm 0 0.2cm},clip', fig.cap = "Figure 8. fastANI representation"}
...
```{r Figure 9, echo= FALSE, fig.align = 'center', out.width = "62%", out.extra='trim={0 0.28cm 0 0.28cm},clip', fig.cap = "Figure 9. Functional categories encoded in MAG (left) and reference (right) genomes"}
...
```{r Figure 10,  echo=FALSE, fig.align = 'center', out.width = "40%", fig.show='hold',fig.cap = "Figure 10. MAG (left) and reference (right) genes graphic"}
library("ape")
library("ggplot2")
...
reference genome is depicted in *Figure 11*, revealing 9 mismatches
across the 963 bp sequence length. These mismatches are visually
highlighted in *Figure 12*, displaying a gap in the consensus sequence
(black box). Notably, the multiple aminoacid alignment sequences is
showcased in *Figure 13* and more explicitly in *Figure 14*. Among the 9

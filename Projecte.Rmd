...
```{r MAG,  echo=FALSE, fig.align = 'center', out.width = "50%", fig.show='hold', fig.cap = "MAG graphic"}
library("ape")
library("ggplot2")
...
```{r Ref, echo=FALSE, fig.align = 'center', out.width = "50%", fig.show='hold', fig.cap = "Reference Graphic"}
library("ape")
library("ggplot2")

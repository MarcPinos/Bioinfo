...
```{r Figure 1, echo= FALSE, fig.align = 'center', out.width = "40%", out.extra='trim={0 0.4cm 0 0.4cm},clip', fig.cap = "\\scriptsize \\textbf{Figure 1.}. Quality check reads scores"}
...
Having analyzed our sample throughout all 5 practicals, we can set a
series of conclusions from it.

First, in practical 4 our sequence was first computed and examined in
order to elucidate its quality and possible compilation to an integrated
genome. Its quality was believed to be quite high, as many of the reads
presented such trait. Therefore, trimming was unnecessary and could be
directly assembled. Several contigs were created which enabled the
composition of 7 bins. Among those, only the third fulfilled both
completeness and contamination requirements.

Then, using the chosen bin, and comparing it to a reference genome we
could identify the sample procedence. The whole genome assembly was
identified as *Bifidobacterium dentium*. *Bifidobacterium* is a genus of
gram-positive, non motile, anaerobic bacteria. They are mainly known as
inhabitants of the gastrointestinal tract in mammals, although some
strains have been isolated in both vaginal and oral microbiota. Their
establishment in the human intestine is believed to be linked to
beneficial health effects, such as immune development, neuromodulation,
and microbiotal homeostasis. In particular, *Bifidobacterium dentium* is
found in both intestinal and oral environments, and has been related to
goblet cell maturation, serotonin production, and GABA production,
regulating the gut-brain-axis.

Afterwards, the genome was further examined by studying its functional
categories. It presented a wide variety of physiological functions,
which were coded in several identified genes.

...
```{r Supp. 1, echo= FALSE, fig.align = 'center', out.width = "60%", out.extra='trim={0 0.1cm 0 0.1cm},clip', fig.cap = "\\scriptsize \\textbf{Supplementary Info. 1} FstQ nucleotide sequence alignment between MAG (up) and reference (down)."}
knitr::include_graphics(here::here("pairwase_nt_alignm.png"))
```

```{r Supp. 2, echo= FALSE, fig.align = 'center', out.width = "60%", out.extra='trim={0 0.1cm 0 0.1cm},clip', fig.cap = "\\scriptsize \\textbf{Supplementary Info. 2} FstQ nucleotide sequence alignment between MAG (up) and reference (down)."}
